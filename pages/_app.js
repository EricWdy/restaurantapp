...
function MyApp(props){
  ...
  const [urState,seturState] = useState(null)
  ...
  return (
    <AppContext.Provider value={{cart: state.cart, addItem: addItem, removeItem: removeItem, isAuthenticated:isAuth, setisAuth:setisAuth, user:urState, setUser:seturState}}>
      <Head>
        <link
          rel="stylesheet"
